...
class VisionModule:
    def __init__(self):
        ...
        rospy.Subscriber("/camera/depth/image_raw", Image, self.depth_img_callback)
        rospy.Subscriber("/odom", Odometry, self.odom_callback)
        self.pos_pub = rospy.Publisher('/my_pos/global_pos', Odometry, queue_size=1)
    ...
    def timer_callback(self, data):
        try:
            ...
            if u or v:
                ...
                print("the goal_x_pos, goal_y_pos is:%f %f" % (self.goal_x_pos, self.goal_y_pos))
    ...
    def pixel2world(self, u, v, z):
        ...
        x_world = x_cam * np.cos(self.angle) - y_cam * np.sin(self.angle) + self.x_pos
        y_world = x_cam * np.sin(self.angle) + y_cam * np.cos(self.angle) + self.y_pos
        z_world = z
    ...
    def move_control(self):
        ...
        beta = -math.atan2(self.goal_y_pos - self.y_pos, self.goal_x_pos - self.x_pos)
